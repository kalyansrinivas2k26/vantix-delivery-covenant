...
| Material scope change | Sponsor / Change Authority | None | Detect + route |
| Contingency release | Named financial/project authority | None | Detect + route |
| Risk acceptance | Risk Owner | None | Validate authority |
| Milestone acceptance | Business / Project Owner | None | Evidence gate |
| Benefit acceptance | Benefit Owner | None | Evidence gate |
